...
$$
t_{\alpha/2, \, n-1} = \text{QT}\left(\frac{1 + \text{confidence level}}{2}, \, n-1\right)
$$
...
margin_of_error <- t_score * (std_speed / sqrt(n))

# Calculate the 90% confidence interval for speed
ci_lower_speed <- mean_speed - margin_of_error
ci_upper_speed <- mean_speed + margin_of_error
